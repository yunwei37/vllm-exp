# State Transition Analysis - high_label_churn_over3
...
- **Framework**: llama_cpp
- **Method Type**: state_transition
- **Sample Name**: high_label_churn_over3
- **Sample Size**: 30
- **Sampling Criteria**: Issues with high_label_churn_over3 state transitions
